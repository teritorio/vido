...
const colorMigrationTable: Record<string, string> = {
  ...
  '#db7900': '#cc4c16', // Restauration & Bar
  '#009cb8': '#278096', // Commerces de proximité
  ...
  '#00a757': '#008A1E', // Loisirs
  '#008ecf': '#007db8', // Mobilités
  '#8cc56f': '#006b31', // Nature
  '#f25c05': '#BD533C', // Produits locaux
  '#1d1d1b': '#000000', // Point de repères du territoire
  '#e50980': '#c02469', // Elements notables
  '#e42224': '#e42224', // Santé
  '#4e7ab5': '#5173B7', // Commerces de services
