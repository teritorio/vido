export default defineI18nLocale(() => {
  return {
    ...
    poiDetails: {
      ...
      report: 'Notificar un problema',
    },
    poisTable: {
      empty: 'La lista está vacía: seleccione una categoría',
      details: 'Detalles',
    ...
    categorySelector: {
      ...
      placeholderAdd: 'Ver una categoría',
    ...
    isochrone: {
      ...
      overlay: {
        ...
        text: 'Visualiza en el mapa las zonas accesibles desde este punto de inicio en función de la duración (15, 30, 60 minutos) y de la modalidad de viaje.',
      },
      profiles: {
