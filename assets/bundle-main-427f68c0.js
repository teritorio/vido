...
import { f as files, m as mapFile, t as tree, _ as _sfc_main$c, __tla as __tla_1 } from "./GenericMountStory.vue2-0b8efc3d.js";
import { u as useScrollOnActive, B as BaseListItemLink, _ as _export_sfc, a as useStoryStore, b as _sfc_main$b, i as isMobile, c as BaseSplitPane, __tla as __tla_2 } from "./MobileOverlay.vue2-9ee3486c.js";
import { i as isDark, t as toggleDark, r as router, __tla as __tla_3 } from "./__resolved__virtual__histoire-support-plugins-client-653ca2b1.js";
import { h as histoireConfig, c as customLogos } from "./config-23d2cc81.js";
let onKeyboardShortcut, useCommandStore;
let __tla = Promise.all([
  ...
  const _hoisted_1$a = {
    class: "bind-tree-margin htw-flex htw-items-center htw-gap-2 htw-pl-4 htw-min-w-0"
  };
  const _hoisted_2$6 = {
    class: "htw-truncate"
  };
  ...
  const StoryListItem = _export_sfc(_sfc_main$a, [
    [
      "__scopeId",
      "data-v-19810958"
    ]
  ...
  const _hoisted_3$4 = {
    class: "bind-tree-padding htw-flex htw-items-center htw-gap-2 htw-min-w-0"
  };
  const _hoisted_4$3 = {
    class: "htw-flex htw-flex-none htw-items-center htw-opacity-30 [.histoire-story-list-folder-button:hover_&]:htw-opacity-100 htw-ml-4 htw-w-4 htw-h-4 htw-rounded-sm htw-border htw-border-gray-500/40"
  };
  const _hoisted_5$1 = {
    class: "htw-truncate"
  };
            ...
            createBaseVNode("span", _hoisted_3$4, [
              createBaseVNode("span", _hoisted_4$3, [
                createVNode(unref(Icon), {
                  ...
                  class: normalizeClass([
                    "htw-w-full htw-h-full htw-transition-transform htw-duration-150",
                    {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.folder.children, (element) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                element.children ? (openBlock(), createBlock(_component_StoryListFolder, {
                  ...
                  "stories",
                  "depth"
                ])) : (openBlock(), createBlock(StoryListItem, {
                  key: 1,
  ...
  const StoryListFolder = _export_sfc(_sfc_main$9, [
    [
      "__scopeId",
      "data-v-2d2e4786"
    ]
  ...
  const _hoisted_2$4 = createBaseVNode("div", {
    class: "htw-h-[1px] htw-bg-gray-500/10 htw-mx-6 htw-mb-2 group-first:htw-hidden"
  }, null, -1);
  const _hoisted_3$3 = [
    "onKeyup"
  ];
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", _hoisted_1$8, [
          __props.group.title ? (openBlock(), createElementBlock(Fragment, {
            key: 0
          }, [
            _hoisted_2$4,
            createBaseVNode("div", {
  ...
  const _hoisted_1$7 = {
    class: "histoire-story-list htw-overflow-y-auto"
  };
  ...
  onKeyboardShortcut = function(shortcut, handler, options = {}) {
  ...
  function makeTooltip(descriptionHtml, keyboardShortcut) {
    return {
      content: `<div>${descriptionHtml}</div><div class="htw-flex htw-items-center htw-gap-1 htw-mt-2 htw-text-sm">${genKeyboardShortcutHtml(keyboardShortcut({
        isMac
      }))}</div>`,
      html: true
    };
  ...
  const _hoisted_2$3 = {
    class: "htw-py-3 sm:htw-py-4 htw-flex-1 htw-h-full htw-flex htw-items-center htw-pr-2"
  };
  const _hoisted_3$2 = [
    "href"
  ];
  const _hoisted_4$1 = {
    class: "htw-ml-auto htw-flex-none htw-flex"
  };
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$5, [
          ...
          createBaseVNode("div", _hoisted_4$1, [
            withDirectives((openBlock(), createElementBlock("a", {
              ...
              [
                _directive_tooltip,
                unref(makeTooltip)("Search", ({ isMac: isMac2 }) => isMac2 ? "meta+k" : "ctrl+k")
              ]
            ]),
            !unref(histoireConfig).theme.hideColorSchemeSwitch ? withDirectives((openBlock(), createElementBlock("a", {
              ...
              [
                _directive_tooltip,
                unref(makeTooltip)("Toggle dark mode", ({ isMac: isMac2 }) => isMac2 ? "meta+shift+d" : "ctrl+shift+d")
              ]
            ]) : createCommentVNode("", true)
          ])
        ]);
  ...
  useCommandStore = defineStore("command", () => {
  ...
  const _hoisted_1$4 = {
    class: "histoire-breadcrumb"
  };
  const _hoisted_2$2 = _withScopeId(() => createBaseVNode("span", {
    class: "htw-opacity-40"
  }, " / ", -1));
  const _hoisted_3$1 = {
        ...
        return openBlock(), createElementBlock(Fragment, null, [
          createBaseVNode("div", _hoisted_1$4, [
            createBaseVNode("a", {
              ...
              unref(story) ? (openBlock(), createElementBlock(Fragment, {
                key: 0
              }, [
  ...
  const Breadcrumb = _export_sfc(_sfc_main$4, [
    [
      "__scopeId",
      "data-v-36846ccf"
    ]
  ...
  const _hoisted_2$1 = {
    class: "htw-bg-white dark:htw-bg-gray-900 md:htw-mt-16 md:htw-mx-auto htw-w-screen htw-max-w-[512px] htw-shadow-xl htw-border htw-border-gray-200 dark:htw-border-gray-750 htw-rounded-lg htw-relative htw-divide-y htw-divide-gray-200 dark:htw-divide-gray-850"
  };
  const _sfc_main$2 = defineComponent({
    ...
    setup(__props, { emit }) {
      const SearchPane = defineAsyncComponent({
        loader: () => __vitePreload(() => import("./SearchPane.vue-dcd62a15.js").then(async (m) => {
          await m.__tla;
          return m;
        }), true ? ["assets/SearchPane.vue-dcd62a15.js","assets/vendor-ec6df5a6.js","assets/MobileOverlay.vue2-9ee3486c.js","assets/__resolved__virtual__histoire-support-plugins-client-653ca2b1.js","assets/config-23d2cc81.js","assets/BaseEmpty.vue-13015f26.js","assets/GenericMountStory.vue2-0b8efc3d.js"] : void 0),
  ...
  const _hoisted_1$1 = {
    class: "histoire-initial-loading htw-fixed htw-inset-0 htw-bg-white dark:htw-bg-gray-700 htw-flex htw-flex-col htw-gap-6 htw-items-center htw-justify-center"
  };
              ...
              progress.total > 0 ? (openBlock(), createElementBlock("div", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(progress.total, (n) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", {
                      class: normalizeClass([
                        "htw-w-3 htw-h-3 htw-bg-primary-500 htw-rounded-full htw-duration-150 htw-ease-out",
                        {
  ...
  const _hoisted_3 = {
    class: "htw-flex htw-flex-col htw-h-full htw-bg-gray-100 dark:htw-bg-gray-750 __histoire-pane-shadow-from-right"
  };
  const __default__ = {
    name: "HistoireApp"
  };
