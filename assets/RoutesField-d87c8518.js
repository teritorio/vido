...
import { P as PropertyTranslationsContextEnum, __tla as __tla_1 } from "./property-translations-fcaee93b.js";
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.routes, (route, activity) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("ul", _hoisted_5, [
              _ctx.difficulty(activity, route) ? (openBlock(), createElementBlock("li", _hoisted_6, toDisplayString(_ctx.$t("fields.route.difficulty")) + " " + toDisplayString(_ctx.difficulty(activity, route)), 1)) : createCommentVNode("v-if", true),
              _ctx.duration(route) ? (openBlock(), createElementBlock("li", _hoisted_7, toDisplayString(_ctx.$t("fields.route.duration")) + " " + toDisplayString(_ctx.duration(route)), 1)) : createCommentVNode("v-if", true)
            ])
          ]);
        }), 128))
      ]))
