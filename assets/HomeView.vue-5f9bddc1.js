...
import { d as defineComponent, c as computed, e as createElementBlock, g as createBaseVNode, a as unref, o as openBlock, __tla as __tla_0 } from "./vendor-c1ea6bed.js";
let _sfc_main;
let __tla = Promise.all([
  ...
  const _hoisted_1 = {
    class: "histoire-home-view htw-flex htw-items-center htw-justify-center htw-h-full"
  };
  const _hoisted_2 = [
    "src"
  ];
