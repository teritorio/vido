import { d as defineComponent, l as resolveComponent, o as openBlock, q as createBlock, w as withCtx, g as createBaseVNode, n as normalizeClass, m as withKeys, Z as renderSlot, X as mergeProps, k as watch, $ as scrollIntoView, J as onMounted, i as defineStore, r as ref, c as computed, a0 as onUnmounted, e as createElementBlock, a1 as withModifiers, G as normalizeStyle, a as unref, a2 as useMediaQuery, t as toDisplayString, f as createVNode, I as Icon, h as createCommentVNode, T as Transition, __tla as __tla_0 } from "./vendor-ec6df5a6.js";
import { r as router, __tla as __tla_1 } from "./__resolved__virtual__histoire-support-plugins-client-653ca2b1.js";
let BaseListItemLink, _export_sfc, useStoryStore, _sfc_main, BaseSplitPane, isMobile, useScrollOnActive;
let __tla = Promise.all([
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return openBlock(), createBlock(_component_RouterLink, mergeProps({
      ...
      default: withCtx(({ isActive: linkIsActive, href, navigate }) => [
        createBaseVNode("a", {
          ...
          class: normalizeClass([
            "htw-flex htw-items-center htw-gap-2 htw-text-gray-900 dark:htw-text-gray-100",
            [
              _ctx.$attrs.class,
          ...
          onKeyup: [
            withKeys(($event) => _ctx.handleNavigate($event, navigate), [
              "enter"
            ]),
            withKeys(($event) => _ctx.handleNavigate($event, navigate), [
              "space"
  ...
  BaseListItemLink = _export_sfc(_sfc_main$2, [
    [
      "render",
      _sfc_render
    ]
  ]);
  useScrollOnActive = function(active, el) {
    watch(active, (value) => {
      if (value) {
        autoScroll();
      }
  ...
  useStoryStore = defineStore("story", () => {
    const stories = ref([]);
    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", {
          ...
          ref: el,
          class: normalizeClass([
            "histoire-base-split-pane htw-flex htw-h-full htw-isolate htw-overflow-auto",
            {
          ...
          createBaseVNode("div", {
            class: normalizeClass([
              "htw-relative htw-top-0 htw-left-0 htw-z-20",
              {
            ...
            createBaseVNode("div", {
              class: normalizeClass([
                "dragger htw-absolute htw-z-100 hover:htw-bg-primary-500/50 htw-transition-colors htw-duration-150 htw-delay-150",
                {
              ...
              onMousedown: withModifiers(dragStart, [
                "prevent"
              ])
          ...
          createBaseVNode("div", {
            class: normalizeClass([
              "htw-relative htw-bottom-0 htw-right-0",
              {
                "htw-pointer-events-none": dragging.value,
  ...
  BaseSplitPane = _export_sfc(_sfc_main$1, [
    [
      "__scopeId",
      "data-v-ed925107"
    ]
  ...
  const _hoisted_2 = {
    class: "htw-p-4 htw-h-16 htw-flex htw-border-b htw-border-gray-100 dark:htw-border-gray-800 htw-items-center htw-place-content-between"
  };
  const _hoisted_3 = {
    class: "htw-text-gray-500"
  };
