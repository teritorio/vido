...
import { p as property_translations_PIWCHHX3IP, __tla as __tla_1 } from "./property-translations-1fdfea06.js";
let entry$1;
let __tla = Promise.all([
  ...
  const _sfc_main = {
    ...
    setup(__props, { expose }) {
      expose();
      const ErrorComponent = defineAsyncComponent(() => __vitePreload(() => import("./error-component-4ebe3939.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? ["assets/error-component-4ebe3939.js","assets/vendor-fe86adbc.js"] : void 0).then((r) => r.default || r));
