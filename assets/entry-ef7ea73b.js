...
import { p as property_translations_PIWCHHX3IP, __tla as __tla_1 } from "./property-translations-98d98cd7.js";
let entry$1;
let __tla = Promise.all([
  ...
  const vido_config_M7tFtI8bDB = defineNuxtPlugin((nuxtApp) => {
    ...
    return {
      provide: {
        ...
        vidoConfig: () => config2 || vidoConfig(useRequestHeaders())
      }
    };
  });
  ...
  const _sfc_main = {
    ...
    setup(__props, { expose }) {
      expose();
      const ErrorComponent = defineAsyncComponent(() => __vitePreload(() => import("./error-component-ba07e6ed.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? ["assets/error-component-ba07e6ed.js","assets/vendor-c1ea6bed.js"] : void 0).then((r) => r.default || r));
