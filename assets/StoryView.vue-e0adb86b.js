import { b as useRoute, c as computed, d as defineComponent, u as useCssVars, a as unref, a6 as toRefs, r as ref, o as openBlock, e as createElementBlock, f as createVNode, w as withCtx, I as Icon, n as normalizeClass, g as createBaseVNode, t as toDisplayString, i as defineStore, j as useStorage, a7 as unindent, x as resolveDirective, y as withDirectives, a8 as useRouter, a9 as useResizeObserver, l as resolveComponent, q as createBlock, aa as Xg, h as createCommentVNode, G as normalizeStyle, a1 as withModifiers, A as pushScopeId, B as popScopeId, k as watch, Z as renderSlot, m as withKeys, z as createTextVNode, F as Fragment, p as renderList, J as onMounted, ab as vModelText, a0 as onUnmounted, ac as VTooltip, ad as createStaticVNode, s as useEventListener, E as reactive, a5 as applyState, ae as toRaw, X as mergeProps, af as Dropdown, ag as clone, ah as omit, ai as useTimeoutFn, aj as onClickOutside, v as isRef, ak as nextTick, al as Zg, am as zg, an as jg, ao as Wg, Y as resolveDynamicComponent, _ as __vitePreload, W as watchEffect, V as markRaw, ap as shallowRef, aq as getHighlighter, T as Transition, a4 as h, ar as onBeforeUnmount, __tla as __tla_0 } from "./vendor-fe86adbc.js";
import { u as useScrollOnActive, B as BaseListItemLink, _ as _export_sfc, a as useStoryStore, i as isMobile, c as BaseSplitPane, b as _sfc_main$y, __tla as __tla_1 } from "./MobileOverlay.vue2-e54aa3a3.js";
import { B as BaseEmpty, __tla as __tla_2 } from "./BaseEmpty.vue-92a58a50.js";
import { g as getContrastColor, _ as _sfc_main$x, b as SANDBOX_READY, E as EVENT_SEND, S as STATE_SYNC, t as toRawDeep, P as PREVIEW_SETTINGS_SYNC, __tla as __tla_3 } from "./state-86828511.js";
import { h as histoireConfig } from "./config-23d2cc81.js";
import { c as clientSupportPlugins, b as base, i as isDark, __tla as __tla_4 } from "./__resolved__virtual__histoire-support-plugins-client-b549e38d.js";
let _sfc_main;
let __tla = Promise.all([
            ...
            default: withCtx(({ active }) => [
              createVNode(unref(Icon), {
                ...
                class: normalizeClass([
                  "htw-w-5 htw-h-5 sm:htw-w-4 sm:htw-h-4 htw-flex-none",
                  {
  ...
  const StoryVariantListItem = _export_sfc(_sfc_main$w, [
    [
      "__scopeId",
      "data-v-ab890d9c"
    ]
  ...
  const _hoisted_2$i = createBaseVNode("pattern", {
    id: "checkerboard",
    width: "64",
    height: "64",
  ...
  const _hoisted_3$e = createBaseVNode("rect", {
    x: "0",
    y: "0",
    width: "100%",
    height: "100%",
  ...
  const CheckerboardPattern = _export_sfc(_sfc_main$u, [
    [
      "render",
      _sfc_render$4
    ]
  ...
  const _hoisted_1$p = {
    class: "htw-flex-none htw-flex htw-items-center"
  };
  const _hoisted_2$h = {
    class: "htw-truncate htw-flex-1"
  };
  const _hoisted_3$d = {
    class: "htw-flex-none htw-ml-auto htw-hidden group-hover:htw-flex htw-items-center"
  };
  const _hoisted_4$9 = _withScopeId$2(() => createBaseVNode("div", {
        ...
        return openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_1$p, [
            withDirectives((openBlock(), createBlock(_component_RouterLink, {
              to: unref(targetRoute),
              class: normalizeClass([
                "htw-rounded htw-w-max htw-px-2 htw-py-0.5 htw-min-w-16 htw-cursor-pointer htw-flex htw-items-center htw-gap-1 htw-flex-shrink",
                {
              ...
              default: withCtx(() => [
                createVNode(unref(Icon), {
                  icon: unref(variant).icon ?? "carbon:cube",
                  class: normalizeClass([
                    "htw-w-4 htw-h-4 htw-opacity-50",
                    {
          ...
          createBaseVNode("div", {
            class: normalizeClass([
              "htw-border htw-bg-white dark:htw-bg-gray-700 htw-rounded htw-flex-1 htw-p-4 htw-relative",
              {
            ...
            onClick: _cache[0] || (_cache[0] = withModifiers(($event) => selectVariant(), [
              "stop"
            ])),
  ...
  const StoryVariantGridItem = _export_sfc(_sfc_main$t, [
    [
      "__scopeId",
      "data-v-cf76cd68"
    ]
  ...
  const _hoisted_1$o = {
    class: "htw-text-white htw-w-[16px] htw-h-[16px] htw-relative"
  };
  const _hoisted_2$g = {
    width: "16",
    height: "16",
    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", {
          ...
          onKeydown: [
            _cache[1] || (_cache[1] = withKeys(withModifiers(($event) => toggle(), [
              "prevent"
            ]), [
              "enter"
            ])),
            _cache[2] || (_cache[2] = withKeys(withModifiers(($event) => toggle(), [
              "prevent"
            ]), [
              "space"
            ]))
          ...
          createBaseVNode("div", _hoisted_1$o, [
            createBaseVNode("div", {
              class: normalizeClass([
                "htw-border group-active:htw-bg-gray-500/20 htw-rounded-sm htw-box-border htw-absolute htw-inset-0 htw-transition-border htw-duration-150 htw-ease-out",
                [
            ...
            (openBlock(), createElementBlock("svg", _hoisted_2$g, [
              createBaseVNode("path", {
                ...
                fill: "none",
                class: normalizeClass([
                  "htw-stroke-white htw-stroke-2 htw-duration-200 htw-ease-in-out",
                  [
  ...
  const _hoisted_7$3 = {
    class: "htw-ml-auto htw-opacity-70"
  };
  const _hoisted_8$2 = {
    key: 0
  };
            ...
            createBaseVNode("div", _hoisted_4$8, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(histoireConfig).backgroundPresets, (option, index) => {
                return openBlock(), createElementBlock("button", {
                  key: index,
                  class: normalizeClass([
                    "htw-px-4 htw-py-3 htw-cursor-pointer htw-text-left htw-flex htw-items-baseline htw-gap-4",
                    [
                  ...
                  option.color !== "$checkerboard" ? (openBlock(), createElementBlock(Fragment, {
                    key: 0
                  }, [
  ...
  const ToolbarBackground = _export_sfc(_sfc_main$r, [
    [
      "__scopeId",
      "data-v-c48fb2b2"
    ]
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return withDirectives((openBlock(), createElementBlock("a", {
          ...
          [
            _directive_tooltip,
            `Switch to text direction ${unref(settings).textDirection === "ltr" ? "Right to Left" : "Left to Right"}`
          ]
        ]);
      };
    }
  ...
  const _hoisted_1$m = {
    class: "histoire-story-variant-grid htw-flex htw-flex-col htw-items-stretch htw-h-full __histoire-pane-shadow-from-right"
  };
  const _hoisted_2$e = {
    key: 0,
  ...
  const _hoisted_1$l = {
    class: "histoire-toolbar-title htw-flex htw-items-center htw-gap-1 htw-text-gray-500 htw-flex-1 htw-truncate htw-min-w-0"
  };
  ...
  const _hoisted_2$d = {
    class: "htw-flex htw-items-center htw-gap-2 htw-px-4 htw-py-3"
  };
  const _hoisted_3$9 = createBaseVNode("span", {
  ...
  const _hoisted_5$4 = {
    class: "htw-ml-auto htw-opacity-70 htw-flex htw-gap-1"
  };
  const _hoisted_6$3 = {
    key: 0
  };
            ...
            createBaseVNode("div", _hoisted_1$k, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(histoireConfig).responsivePresets, (preset, index) => {
                return openBlock(), createElementBlock("button", {
                  key: index,
                  class: normalizeClass([
                    "htw-px-4 htw-py-3 htw-cursor-pointer htw-text-left htw-flex htw-gap-4",
                    [
          ...
          default: withCtx(() => {
            ...
            return [
              withDirectives((openBlock(), createElementBlock("div", {
                class: normalizeClass([
                  "htw-flex htw-items-center htw-gap-1 htw-h-full htw-px-2 htw-group",
                  {
  ...
  const _sfc_main$m = {};
  const _hoisted_1$j = {
    class: "__histoire-hatched-pattern"
  };
  function _sfc_render$3(_ctx, _cache) {
    return openBlock(), createElementBlock("div", _hoisted_1$j);
  }
  const HatchedPattern = _export_sfc(_sfc_main$m, [
    [
      "render",
      _sfc_render$3
    ],
  ...
  const _hoisted_1$i = {
    class: "histoire-story-responsive-preview htw-w-full htw-h-full htw-flex-1 htw-rounded-lg htw-relative htw-overflow-hidden"
  };
  const _hoisted_2$c = {
    key: 0,
  ...
  const _sfc_main$l = defineComponent({
    ...
    setup(__props) {
      ...
      const sizeTooltip = computed(() => (responsiveWidth.value ?? "Auto") + " \xD7 " + (responsiveHeight.value ?? "Auto"));
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", _hoisted_1$i, [
          unref(isResponsiveEnabled) ? (openBlock(), createElementBlock("div", _hoisted_2$c, [
            createVNode(HatchedPattern, {
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              class: normalizeClass([
                "htw-h-full htw-overflow-hidden htw-bg-white dark:htw-bg-gray-700 htw-rounded-lg htw-relative",
                unref(isResponsiveEnabled) ? {
              ...
              createBaseVNode("div", _hoisted_3$8, [
                ...
                unref(isResponsiveEnabled) ? (openBlock(), createElementBlock(Fragment, {
                  key: 1
                }, [
                  withDirectives((openBlock(), createElementBlock("div", {
  ...
  const StoryResponsivePreview = _export_sfc(_sfc_main$l, [
    [
      "__scopeId",
      "data-v-a83b1911"
    ]
        ...
        return openBlock(), createBlock(StoryResponsivePreview, {
          ...
          default: withCtx(({ isResponsiveEnabled, finalWidth, finalHeight, resizing }) => [
            createBaseVNode("iframe", {
              ...
              class: normalizeClass([
                "htw-w-full htw-h-full htw-relative",
                {
      ...
      return (_ctx, _cache) => {
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$g, [
          !unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2$b, [
            ...
            !__props.variant.responsiveDisabled ? (openBlock(), createBlock(_sfc_main$n, {
              key: 0
            })) : createCommentVNode("", true),
            createVNode(ToolbarBackground),
            createVNode(_sfc_main$q),
          ...
          ((_b = __props.story.layout) == null ? void 0 : _b.iframe) === false ? (openBlock(), createBlock(_sfc_main$k, {
            key: 1,
            story: __props.story,
            variant: __props.variant
          }, null, 8, [
        ...
        return unref(hasSingleVariant) && unref(variant) ? (openBlock(), createElementBlock("div", _hoisted_1$f, [
          ...
          unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2$a, [
            createBaseVNode("a", {
              ...
              unref(variant) ? (openBlock(), createElementBlock(Fragment, {
                key: 0
              }, [
                createVNode(unref(Icon), {
                  icon: unref(variant).icon ?? "carbon:cube",
                  class: normalizeClass([
                    "htw-w-5 htw-h-5 htw-flex-none",
                    {
  ...
  const StoryVariantSingle = _export_sfc(_sfc_main$h, [
    [
      "__scopeId",
      "data-v-ddfc5b4f"
    ]
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock(Fragment, null, [
          createBaseVNode("div", _hoisted_1$e, [
            unref(storyStore).currentStory.layout.type === "grid" ? (openBlock(), createBlock(_sfc_main$p, {
              key: 0
            })) : unref(storyStore).currentStory.layout.type === "single" ? (openBlock(), createBlock(StoryVariantSingle, {
              key: 1,
  ...
  const StoryViewer = _export_sfc(_sfc_main$g, [
    [
      "__scopeId",
      "data-v-6046525f"
    ]
            ...
            createBaseVNode("div", _hoisted_3$6, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(formattedOptions), (label, value) => {
                return openBlock(), createElementBlock("div", mergeProps({
                  ...
                  key: label,
                  class: [
                    "htw-px-2 htw-py-1 htw-cursor-pointer hover:htw-bg-primary-100 dark:hover:htw-bg-primary-700",
                    {
  ...
  const _hoisted_5$1 = {
    class: "htw-flex htw-gap-2 htw-items-center"
  };
  const _hoisted_6$1 = {
    class: "htw-flex-1 htw-truncate"
  };
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$c, [
          createBaseVNode("div", {
            ...
            createVNode(_sfc_main$f, {
              ...
              onKeydown: [
                _cache[4] || (_cache[4] = withKeys(($event) => stopEditing(), [
                  "enter"
                ])),
                _cache[5] || (_cache[5] = withKeys(($event) => stopEditing(), [
                  "escape"
                ]))
              ],
              ...
              default: withCtx(({ label }) => [
                isEditing.value ? withDirectives((openBlock(), createElementBlock("input", {
                  ...
                  [
                    vModelText,
                    unref(presetStates).get(unref(selectedOption)).label
                  ]
                  ...
                  unref(canEdit) ? withDirectives((openBlock(), createBlock(unref(Icon), {
                    ...
                    onClick: _cache[1] || (_cache[1] = withModifiers(($event) => startEditing(), [
                      "stop"
                    ]))
                  }, null, 512)), [
                    [
              ...
              option: withCtx(({ label, value }) => [
                createBaseVNode("div", _hoisted_5$1, [
                  ...
                  value !== DEFAULT_ID ? withDirectives((openBlock(), createBlock(unref(Icon), {
                    ...
                    class: "htw-flex-none htw-cursor-pointer htw-w-4 htw-h-4 hover:htw-text-primary-500 htw-opacity-50 hover:htw-opacity-100 dark:hover:htw-text-primary-400 htw-text-gray-900 dark:htw-text-gray-100",
                    onClick: withModifiers(($event) => deletePreset(value), [
                      "stop"
                    ])
                  }, null, 8, [
                    "onClick"
          ...
          withDirectives(createVNode(unref(Icon), {
            ...
            class: normalizeClass([
              "htw-cursor-pointer htw-w-4 htw-h-4 hover:htw-text-primary-500 dark:hover:htw-text-primary-400 htw-text-gray-900 dark:htw-text-gray-100",
              [
            ...
            [
              _directive_tooltip,
              savedNotif.value ? "Saved!" : unref(canEdit) ? "Save to preset" : null
            ]
          ]),
          withDirectives(createVNode(unref(Icon), {
            icon: "carbon:add-alt",
        ...
        return unref(comp) ? (openBlock(), createBlock(resolveDynamicComponent(unref(comp)), {
          ...
          actions: withCtx(() => [
            withDirectives(createVNode(unref(Icon), {
              ...
              onClick: _cache[0] || (_cache[0] = withModifiers(($event) => reset(), [
                "stop"
              ]))
            }, null, 8, [
              "class"
  ...
  const _hoisted_2$7 = {
    class: "htw-font-mono htw-p-2 htw-flex htw-items-center htw-gap-1"
  };
  const _hoisted_3$4 = createBaseVNode("span", {
    class: "htw-opacity-30"
  }, "<", -1);
  const _hoisted_4$2 = createBaseVNode("span", {
    class: "htw-opacity-30"
  }, ">", -1);
  ...
  const _hoisted_3$3 = createBaseVNode("span", null, "No controls available for this story", -1);
  const _hoisted_4$1 = {
    key: 2
  };
      ...
      return (_ctx, _cache) => {
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$a, [
          ...
          unref(hasCustomControls) ? (openBlock(), createBlock(_sfc_main$x, {
            ...
            "variant",
            "story"
          ])) : !((_b = (_a = __props.variant.state) == null ? void 0 : _a._hPropDefs) == null ? void 0 : _b.length) ? (openBlock(), createBlock(BaseEmpty, {
            key: 1
          }, {
            default: withCtx(() => [
              createVNode(unref(Icon), {
  ...
  const markdownFiles = reactive({
    "cypress/fixtures/teritorio/references/pois.geojson": () => __vitePreload(() => import("./__resolved__virtual_md_cypress-fixtures-teritorio-references-pois-geojson-e1e04ce0.js"), true ? [] : void 0)
  });
  const _hoisted_1$9 = [
    "innerHTML"
  ];
    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", {
          ...
          createCommentVNode("", true),
          !unref(renderedDoc) ? (openBlock(), createBlock(BaseEmpty, {
            key: 1
          }, {
            default: withCtx(() => [
              createVNode(unref(Icon), {
  ...
  const _hoisted_2$5 = {
    class: "htw-overflow-auto htw-max-w-[400px] htw-max-h-[400px]"
  };
  const _hoisted_3$2 = {
    class: "htw-p-4"
  };
      ...
      return (_ctx, _cache) => {
        ...
        return openBlock(), createBlock(_component_VDropdown, {
          ...
          default: withCtx(({ shown }) => [
            createBaseVNode("div", {
              class: normalizeClass([
                "group-hover:htw-bg-primary-100 dark:group-hover:htw-bg-primary-700 htw-cursor-pointer htw-py-2 htw-px-4 htw-flex htw-items-baseline htw-gap-1 htw-leading-normal",
                [
  ...
  const _sfc_main$8 = defineComponent({
    ...
    setup(__props) {
      ...
      async function resetUnseen() {
        ...
        await nextTick();
        eventsElement.value.scrollTo({
          top: eventsElement.value.scrollHeight
        });
      }
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", {
          ...
          !unref(hasEvents) ? (openBlock(), createBlock(BaseEmpty, {
            key: 0
          }, {
            default: withCtx(() => [
              createVNode(unref(Icon), {
  ...
  const _hoisted_3$1 = _withScopeId(() => createBaseVNode("div", {
    class: "htw-text-gray-900 dark:htw-text-gray-100"
  }, " Source ", -1));
  const _hoisted_4 = _withScopeId(() => createBaseVNode("div", {
    class: "htw-flex-1"
  }, null, -1));
  const _hoisted_5 = {
    class: "htw-flex htw-flex-none htw-gap-px htw-h-full htw-py-2"
  };
  const _hoisted_6 = {
    key: 1,
    class: "htw-text-red-500 htw-h-full htw-p-2 htw-overflow-auto htw-font-mono htw-text-sm"
  };
  const _hoisted_7 = _withScopeId(() => createBaseVNode("span", null, "Not available", -1));
  const _hoisted_8 = [
    "value"
  ];
  const _hoisted_9 = [
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$6, [
          !error.value ? (openBlock(), createElementBlock("div", _hoisted_2$4, [
            ...
            createBaseVNode("div", _hoisted_5, [
              withDirectives((openBlock(), createElementBlock("button", {
                class: normalizeClass([
                  "htw-flex htw-items-center htw-gap-1 htw-h-full htw-px-1 htw-bg-gray-500/10 htw-rounded-l htw-transition-all htw-ease-[cubic-bezier(0,1,.6,1)] htw-duration-300 htw-overflow-hidden",
                  [
                ...
                [
                  _directive_tooltip,
                  !dynamicSourceCode.value ? "Dynamic source code is not available" : displayedSource.value !== "dynamic" ? "Switch to dynamic source" : null
                ]
              ]),
              withDirectives((openBlock(), createElementBlock("button", {
                class: normalizeClass([
                  "htw-flex htw-items-center htw-gap-1 htw-h-full htw-px-1 htw-bg-gray-500/10 htw-rounded-r htw-transition-all htw-ease-[cubic-bezier(0,1,.6,1)] htw-duration-300 htw-overflow-hidden",
                  [
                ...
                [
                  _directive_tooltip,
                  !staticSourceCode.value ? "Static source code is not available" : displayedSource.value !== "static" ? "Switch to static source" : null
                ]
              ])
            ]),
            createVNode(unref(Xg), {
          ...
          error.value ? (openBlock(), createElementBlock("div", _hoisted_6, " Error: " + toDisplayString(error.value), 1)) : !unref(displayedSourceCode) ? (openBlock(), createBlock(BaseEmpty, {
            key: 2
          }, {
            default: withCtx(() => [
              createVNode(unref(Icon), {
  ...
  const StorySourceCode = _export_sfc(_sfc_main$7, [
    [
      "__scopeId",
      "data-v-1bdf9905"
    ]
    ...
    return openBlock(), createBlock(_component_router_link, mergeProps({
      ...
      default: withCtx(({ isActive, isExactActive, href, navigate }) => [
        createBaseVNode("a", mergeProps(_ctx.$attrs, {
          href,
          class: [
            "htw-px-4 htw-h-full htw-inline-flex htw-items-center hover:htw-bg-primary-50 dark:hover:htw-bg-primary-900 htw-relative htw-text-gray-900 dark:htw-text-gray-100",
            {
  ...
  const BaseTab = _export_sfc(_sfc_main$6, [
    [
      "render",
      _sfc_render$2
    ]
  ...
  const _sfc_main$5 = defineComponent({
    ...
    setup(__props) {
      ...
      const ChildrenRender = (props, { slots }) => {
        ...
        return fragment.children.map((vnode, index) => h(ChildWrapper, {
          index
        }, () => [
          vnode
        ]));
      ...
      return (_ctx, _cache) => {
        ...
        return openBlock(), createElementBlock("div", {
          ...
          unref(visibleChildrenCount) < children.value.size ? (openBlock(), createBlock(_component_VDropdown, {
            key: 0
          }, {
            popper: withCtx(() => [
              createBaseVNode("div", _hoisted_2$2, [
                createVNode(ChildrenSlice, {
                  start: unref(visibleChildrenCount)
                }, {
                  default: withCtx(() => [
    ...
    return openBlock(), createBlock(_component_router_link, mergeProps({
      ...
      default: withCtx(({ isActive, isExactActive, href, navigate }) => [
        createBaseVNode("a", mergeProps(_ctx.$attrs, {
          href,
          class: [
            "htw-px-4 htw-h-10 htw-min-w-[150px] htw-inline-flex htw-items-center hover:htw-bg-primary-50 dark:hover:htw-bg-primary-900 htw-relative htw-text-gray-900 dark:htw-text-gray-100",
            {
              "htw-text-primary-500 dark:htw-text-primary-400": _ctx.matched != null ? _ctx.matched : _ctx.exact && isExactActive || !_ctx.exact && isActive
            }
          ],
  ...
  const BaseOverflowTab = _export_sfc(_sfc_main$4, [
    [
      "render",
      _sfc_render$1
    ]
  ...
  const _sfc_main$3 = {};
  const _hoisted_1$2 = {
    class: "histoire-base-tag htw-text-center htw-text-xs htw-mx-1 htw-px-0.5 htw-h-4 htw-uppercase htw-min-w-4 htw-rounded-full htw-bg-primary-500 htw-text-white dark:htw-text-black"
  };
  ...
  const BaseTag = _export_sfc(_sfc_main$3, [
    [
      "render",
      _sfc_render
    ]
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createBlock(_sfc_main$5, {
          class: "histoire-pane-tabs htw-h-10 htw-flex-none htw-border-b htw-border-gray-100 dark:htw-border-gray-750"
        }, {
          overflow: withCtx(() => [
            ...
            createVNode(BaseOverflowTab, {
              ...
              default: withCtx(() => [
                ...
                unref(eventsStore).unseen ? (openBlock(), createBlock(BaseTag, {
                  key: 0
                }, {
                  default: withCtx(() => [
  ...
  const _hoisted_1$1 = createBaseVNode("span", null, "Select a variant", -1);
  const _hoisted_2 = createBaseVNode("span", null, "Loading...", -1);
  const _hoisted_3 = {
    class: "htw-flex htw-flex-col htw-h-full"
  };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return !unref(storyStore).currentStory ? (openBlock(), createBlock(BaseEmpty, {
          ...
          ], 512)) : unref(isMobile) ? (openBlock(), createBlock(StoryViewer, {
            key: 1
          })) : (openBlock(), createBlock(BaseSplitPane, {
            key: 2,
            "save-id": "story-main",
