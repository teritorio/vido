const resource = {
  ...
  "categorySelector": {
    "placeholderSelect": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Seleccione una categoría"])};fn.source="Seleccione una categoría";return fn;})(),
    "placeholderAdd": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Buscar una categoría para añadir"])};fn.source="Buscar una categoría para añadir";return fn;})(),
