import { aE as defineNuxtComponent, a$ as VAutocomplete, as as _export_sfc, ax as openBlock, ay as createElementBlock, aB as createVNode, __tla as __tla_0 } from "./vendor-fe86adbc.js";
let SelectFilter;
let __tla = Promise.all([
  ...
  const _sfc_main = defineNuxtComponent({
    ...
    methods: {
      normalize(str) {
        return str.toLocaleLowerCase().normalize("NFD").replace(/\p{Diacritic}/gu, "");
      },
      filterEasy(value, query) {
