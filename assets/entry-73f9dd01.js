...
import { p as property_translations_PIWCHHX3IP, __tla as __tla_1 } from "./property-translations-fcaee93b.js";
let entry$1;
let __tla = Promise.all([
  ...
  const _sfc_main = {
    ...
    setup(__props, { expose }) {
      expose();
      const ErrorComponent = defineAsyncComponent(() => __vitePreload(() => import("./error-component-7f7816f2.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? ["assets/error-component-7f7816f2.js","assets/vendor-ec6df5a6.js"] : void 0).then((r) => r.default || r));
