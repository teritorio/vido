import { as as _export_sfc, ax as openBlock, av as createBlock, aC as normalizeProps, aD as guardReactiveProps, S as defineAsyncComponent, _ as __vitePreload, __tla as __tla_0 } from "./vendor-ec6df5a6.js";
let nuxtErrorPage;
let __tla = Promise.all([
  ...
  const _sfc_main = {
    ...
    setup(__props, { expose }) {
      ...
      const _Error404 = defineAsyncComponent(() => __vitePreload(() => import("./vendor-ec6df5a6.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.cQ), true ? [] : void 0).then((r) => r.default || r));
      const _Error = defineAsyncComponent(() => __vitePreload(() => import("./vendor-ec6df5a6.js").then(async (m) => {
        await m.__tla;
        return m;
