const resource = {
  ...
  "categorySelector": {
    "placeholderSelect": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Sélectionnez une catégorie"])};fn.source="Sélectionnez une catégorie";return fn;})(),
    "placeholderAdd": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Recherche une catégorie à ajouter"])};fn.source="Recherche une catégorie à ajouter";return fn;})(),
